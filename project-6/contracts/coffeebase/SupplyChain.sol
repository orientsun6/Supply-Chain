...
contract SupplyChain is Ownable, RetailerRole, FarmerRole, DistributorRole, ConsumerRole {
    ...
    modifier verifyCaller(address _address) {
        require(msg.sender == _address, "Can not verify the address!");
        _;
    }
    ...
    modifier checkValue(uint256 _upc, address refundAdress) {
        _;
        uint256 _price = items[_upc].productPrice;
        uint256 amountToReturn = msg.value - _price;
        refundAdress.transfer(amountToReturn);
    }
    ...
    // Call modifer to send any excess ether back to buyer
        checkValue(_upc, items[_upc].distributorID)
    {
